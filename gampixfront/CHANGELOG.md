...
- Cree un proyecto de React con create-vite: `npm init --yes vite@latest gampixfront -- --template=react  --no-rolldown --no-immediate`.
- Actualizando `vite.config.js` con puerto.
- Crear archivo de proyecto (`gampixfront.esproj`).
